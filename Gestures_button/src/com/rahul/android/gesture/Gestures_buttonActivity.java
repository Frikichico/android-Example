package com.rahul.android.gesture;
...
public class Gestures_buttonActivity extends Activity 
	{
    ...
    private OnGesturePerformedListener gesturelistener = new OnGesturePerformedListener() {
        ...
        private View.OnClickListener btnClick = new View.OnClickListener() {
                ...
                public void onClick(View v) {
                        startActivity(new Intent(Gestures_buttonActivity.this,GestureList.class));
                }
        };
}